...
export type NavigationMenuProps<T extends ValidComponent = "ul"> = NavigationMenuPrimitive.NavigationMenuRootProps<T> & {
...
const NavigationMenuDescription = <T extends ValidComponent = "div">(props: PolymorphicProps<T, NavigationMenuDescriptionProps<T>>) => {
	...
	return <NavigationMenuPrimitive.ItemDescription class={cn("text-sm leading-snug text-muted-foreground", local.class)} {...others} />
}
